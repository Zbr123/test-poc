...
public class EmailUtil {
    ...
    public static void Email(){
        ...
        for (String object: toEmailList) {
            sendAttachmentEmail(session, object, "BlazeDemo  Automation Test Results", "Kindly check the attachment for the reports.\n \n \n  Don't reply to this email");
        }
        toEmailList.clear();
    }
    ...
    public static void sendAttachmentEmail(Session session, String toEmail, String subject, String body){
        try{
           ...
           // setReportPath(System.getProperty("user.dir")+"/test-output/HtmlReport/ExtentHtml.html");
            ...
            messageBodyPart.setFileName("BlazeDemo_Automation_Report.html");
